...
<#
	...
	.EXAMPLE
		...
		.\Get-HyperVReport.ps1 -Cluster CLHYPERVFARM.swm.com.ar
	...
	.EXAMPLE
		...
		.\Get-HyperVReport.ps1 -Cluster CLHYPERVFARM.swm.com.ar -SendMail $true -SMTPServer 192.168.105.220 -MailFrom Reporte_Hyper-V@swissmedical.com.ar -SMTPServerTLSorSSL $false -MailTo itservers@swissmedical.com.ar,andres.nicolasy@swissmedical.com.ar
